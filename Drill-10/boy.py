...
class IdleState:
    ...
    def draw(boy):
        if boy.dir == 1:
            boy.image.clip_draw(int(boy.frame) * 182, boy.count * 165, 182, 165, boy.x, boy.y)
        elif boy.dir == -1:
            boy.image.clip_composite_draw(int(boy.frame) * 182, boy.count * 165, 182, 165, 0, 'h', boy.x, boy.y, 182, 165)
